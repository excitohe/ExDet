...
class KittiDatasetMonoCon(KittiMonoDataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(data_root=data_root, info_file=info_file, **kwargs)

        self.min_height = min_height
        self.min_depth = min_depth
        self.max_depth = max_depth
        self.max_trucation = max_trucation
        self.max_occlusion = max_occlusion

    def _parse_ann_info(self, img_info, ann_info):
        """ Parse bbox and mask annotation.
            filter objects based on occlusion, trucation or depth
            compared with its superclass
        Args:
        ...
        for i, ann in enumerate(ann_info):
            ...
            if ann.get('iscrowd', False) or \
                    ann['occluded'] > self.max_occlusion or \
                    ann['truncated'] > self.max_trucation or \
                    ann['center2d'][2] > self.max_depth or \
                    ann['center2d'][2] < self.min_depth or \
